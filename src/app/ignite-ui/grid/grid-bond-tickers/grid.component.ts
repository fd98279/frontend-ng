...
import { IBondTicker } from '../../../bond/bond';
...
export class BondTickersGridComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    @Input() bondTickers: IBondTicker[];
    @Output() bondTickerSelected: EventEmitter<IBondTicker[]> = new EventEmitter();
    public minDate: Date;
    public maxDate: Date;
    ...
    public handleRowSelectionChange(args) {
        setTimeout(() =>  {
            this.bondTickerSelected.emit(args.newSelection);
        }, 1);
    }
